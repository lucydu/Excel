...
import xlutils.copy
# #打开excel
# 路劲：/Users/admin/Desktop/Auto/PycharmProjects/mobile/手机业务线接口用例.xlsx
# excel = xlrd.open_workbook('手机业务线接口用例.xlsx')
# 打印出所有的excel
#
...
def write(raw,col,data):
    ...
    wb.save('手机业务线接口用例.xlsx')
    return()

# sheet.write('2','0','D_002')
# sheet.save('手机业务线接口用例.xlsx')
